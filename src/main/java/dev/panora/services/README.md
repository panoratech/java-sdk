...
public class Main {
  ...
  public static void main(String[] args) {
    PanoraSDK client = new PanoraSDK(System.getenv("PANORASDK_BEARER_TOKEN"));
    try {
      Object response = client.ticketingCommentService.addComment(
        "integrationIdSampleValue",
        "linkedUserIdSampleValue",
        true
      );
...
public class Main {
  ...
  public static void main(String[] args) {
    PanoraSDK client = new PanoraSDK(System.getenv("PANORASDK_BEARER_TOKEN"));
    try {
      Object response = client.ticketingCommentService.getComments(
        "integrationIdSampleValue",
        "linkedUserIdSampleValue",
        true
      );
...
public class Main {
  ...
  public static void main(String[] args) {
    PanoraSDK client = new PanoraSDK(System.getenv("PANORASDK_BEARER_TOKEN"));
    try {
      Object response = client.ticketingCommentService.updateComment("idSampleValue");
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    PanoraSDK client = new PanoraSDK(System.getenv("PANORASDK_BEARER_TOKEN"));
    try {
      Object response = client.ticketingCommentService.getComment("idSampleValue", true);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    PanoraSDK client = new PanoraSDK(System.getenv("PANORASDK_BEARER_TOKEN"));
    try {
      Object response = client.ticketingCommentService.addComments(
        "integrationIdSampleValue",
        "linkedUserIdSampleValue",
        true
      );
