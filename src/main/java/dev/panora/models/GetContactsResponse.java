...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = GetContactsResponse.Builder.class
)
public class GetContactsResponse extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    public GetContactsResponse buildWithoutValidation() {
  ...
  GetContactsResponse(Builder builder) {
    super(builder);
