...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = CreateLinkedUserDto.Builder.class
)
public class CreateLinkedUserDto extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] {
        new java.lang.String[] { "alias", "idProject", "linkedUserOriginId" },
      };
    ...
    public CreateLinkedUserDto build() {
    ...
    public CreateLinkedUserDto buildWithoutValidation() {
      return new CreateLinkedUserDto(this);
    }
  ...
  CreateLinkedUserDto(Builder builder) {
    super(builder);
