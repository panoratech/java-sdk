...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = AddContactsResponse.Builder.class
)
public class AddContactsResponse extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    public AddContactsResponse buildWithoutValidation() {
  ...
  AddContactsResponse(Builder builder) {
    super(builder);
