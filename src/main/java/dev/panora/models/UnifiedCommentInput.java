...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = UnifiedCommentInput.Builder.class
)
public class UnifiedCommentInput extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    public UnifiedCommentInput build() {
    ...
    public UnifiedCommentInput buildWithoutValidation() {
      return new UnifiedCommentInput(this);
    }
  ...
  UnifiedCommentInput(Builder builder) {
    super(builder);
  }
}
