...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = CreateMagicLinkDto.Builder.class
)
public class CreateMagicLinkDto extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups = new java.lang.String[][] {
        new java.lang.String[] { "alias", "email", "idProject", "linkedUserOriginId" },
      };
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("linked_user_origin_id")
    private java.lang.String linkedUserOriginId;
    ...
    public CreateMagicLinkDto build() {
    ...
    public CreateMagicLinkDto buildWithoutValidation() {
      return new CreateMagicLinkDto(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("linked_user_origin_id")
  private final java.lang.String linkedUserOriginId;

  CreateMagicLinkDto(Builder builder) {
    super(builder);
    this.alias = builder.getAlias();
    this.email = builder.getEmail();
    this.idProject = builder.getIdProject();
    this.linkedUserOriginId = builder.getLinkedUserOriginId();
  }
}
