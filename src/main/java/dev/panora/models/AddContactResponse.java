...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
  builder = AddContactResponse.Builder.class
)
public class AddContactResponse extends dev.panora.models.BaseModel {
  ...
  public static class Builder extends dev.panora.models.BaseModel.Builder {
    ...
    public AddContactResponse buildWithoutValidation() {
  ...
  AddContactResponse(Builder builder) {
    super(builder);
